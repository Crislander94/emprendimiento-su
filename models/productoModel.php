<?php
    class Producto{
        ...
        function __construct($tipo_consulta,$inicio_pagina = 0 ,$fin_pagina = 0,$filtros = '',$data1 = '',$data2 = '',$data3 = '',$data4 = '',$data5 = '',$data6 = '', $data7 = '', $data8 = '' , $data9 = '' , $data10 = '') {
        ...
        public function serverQuery($conexionx){
            $call_procedure ="Call sp_productos(?,?,?,?,?,?,?,?,?,?,?,?)";
