<?php
    $link_reg_nuevo = 'categoria/crear';
    $valor          = '"nom_categoria:Nombre Categoria"';
?>
                        ...
                        <form name="filtrocabecera" method="post" id="filtrocabecera" action="">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-4">
                                    <button type="button" id="nuevoform" class="btn btn-success"
                                        onClick="javascript:redireccionar('<?php echo RUTA.$link_reg_nuevo?>');">
                                        <i style="color:white;" class="fa fa-file"></i> Nueva Categoria</button>
                                </div>
...
<script> const ruta = '<?= RUTA?>views/categoria/list-categorias.php';</script>
